				...
				<div class="tables">
					...
					<div class="panel-body widget-shadow">
						...
						<table class="table">
						     ...
						     <button style="background:#F1C40F; float:right; width:100px;"><a href="add_record.php" style="color:white;"> Add Record </a> </button>
							...
							<?php
							  ...
							  <tbody>
								<tr>
								     ...
								     <td><a href='edit_record.php?user=$rid'>Edit</a> | <a href='delete_record.php?user=$rid'>Delete</a> </td>
								</tr>
